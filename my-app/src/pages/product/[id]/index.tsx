...
const SingleProductPage = ({singleProduct}:{singleProduct:Product}) => {
    return (
        <MainLayout>
            <div className="p-4 lg:px-20 xl:px-35 h-screen flex flex-col md:flex-row gap-4 md:gap-8 md:items-center justify-around text-red-500  h-[calc(100vh-6rem)] md:h-[calc(100vh-15rem)] ">
